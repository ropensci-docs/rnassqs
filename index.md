...
`rstudio` user, you can use
[`usethis::edit_r_environ()`](https://usethis.r-lib.org/reference/edit.html)
to open your `.Renviron` file and add a line that looks like:
...
See the examples in
[inst/examples](https://docs.ropensci.org/rnassqs/inst/examples) for
quick recipes to download data.

The primary function is
[`nassqs()`](https://docs.ropensci.org/rnassqs/reference/nassqs.md),
with which you can make any query of variables. For example, to mirror
the request that is on the [NASS API
